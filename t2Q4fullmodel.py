...
class ArbitrationUnit:
    def __init__(self, word_size=16, parent =None):
        ...
        self.left_queues = [Queue(maxsize=4), Queue()]  # two threads
        self.top_queues = [Queue(maxsize=4), Queue()]   # two threads
...
def simulate_systolic_array(a: torch.Tensor, b: torch.Tensor, csv_file: str = "alexnet_T2Q4.csv"):
